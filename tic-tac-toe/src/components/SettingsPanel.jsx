...
import { THEMES, themeColors, applyTheme } from '../utils/themes';
import { getSettings, saveSettings } from '../utils/gameHistory';
          ...
          <div className="theme-options">
            {Object.entries(THEMES).map(([key, value]) => (
              <div
                ...
                style={{ background: themeColors[value].background }}
